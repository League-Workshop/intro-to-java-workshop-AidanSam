...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		int nocolor = -42496;
		int yescolor = -9174785;
		//8. If the mouse falls off the path (if it is on the background)
	if (mouseColor==nocolor) {
		
		scare();
	}
	if (mouseColor==yescolor) {
		JOptionPane.showMessageDialog(null, "you weren't supposed to win");
	}
	}
	...
	private void scare() {
		...
		showScaryImage("SCARYDONOTLOOK.png");
